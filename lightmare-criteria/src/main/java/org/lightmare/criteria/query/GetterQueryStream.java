...
abstract class GetterQueryStream<T extends Serializable> extends AbstractQueryStream<T> {
    ...
    @Override
    public <F> QueryStream<T> equals(FieldGetter<F> field, F value) throws IOException {
    ...
    @Override
    public <F> QueryStream<T> notEquals(FieldGetter<F> field, F value) throws IOException {
    ...
    @Override
    public <F> QueryStream<T> in(FieldGetter<F> field, Collection<F> values) throws IOException {
