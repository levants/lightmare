...
public class ClassLoaderUtils {
    ...
    public static InputStream getClassAsStream(String name) {
        ...
        is = ObjectUtils.callOrInit(resource, ClassLoaderUtils::getResourceAsStream,
                c -> getClassResourceAsStream(name, c));
    ...
    private static void loadClass(String className, ClassLoader loader) {
        ObjectUtils.acceptQuietly(loader, className, ClassLoader::loadClass);
    }
